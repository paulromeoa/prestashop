...
class __TwigTemplate_aa8d5269c0c8f1c5336f9dc294099594accb308b468d4b7ce8869933af58cb62 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"card customer-discounts-card\">
  ...
  <div class=\"card-body\">
    ";
        // line 33
        if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["customerDiscountGrid"] ?? null), "data", [], "any", false, false, false, 33), "records_total", [], "any", false, false, false, 33), 0))) {
            // line 34
            echo "      ";
