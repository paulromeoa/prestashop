...
class __TwigTemplate_6fd6a4cb30f0f2f88f8fa3cf893b3b3a35a14648bc4f240ff20efb051a026a58 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"card customer-addresses-card\">
  ...
  <div class=\"card-body\">
    ";
        // line 39
        if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["customerAddressGrid"] ?? null), "data", [], "any", false, false, false, 39), "records_total", [], "any", false, false, false, 39), 0))) {
            // line 40
            echo "      ";
